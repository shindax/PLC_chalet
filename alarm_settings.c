...
__EEPROM_DATA( WATERING_2, 	  EVERYDAY,	0x16, 0x00, 0x16, 0x15, 0xFF, 0x05 ); // Полив
__EEPROM_DATA( WATERING_2, 	  EVERYDAY,	0x11, 0x35, 0x11, 0x40, 0xFF, 0x06);
__EEPROM_DATA( WATERING_2, 	  EVERYDAY,	0x08, 0x00, 0x08, 0x15, 0xFF, 0x07);
